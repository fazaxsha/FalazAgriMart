...
// ============================================
// File: App.config (Optional - untuk menyimpan Connection String)
...
<configuration>
    <connectionStrings>
        <add name="NeonPostgreSQL" 
             connectionString="Host=your-neon-host.neon.tech;Database=agrimart_db;Username=your_username;Password=your_password;SSL Mode=Require;Trust Server Certificate=true" 
             providerName="Npgsql" />
    </connectionStrings>
...
// ============================================
// CARA MEMBACA CONNECTION STRING DARI App.config
// Edit DatabaseConnection.cs jadi seperti ini:
// ============================================
...
private DatabaseConnection()
{
    ...
    _connectionString = ConfigurationManager.ConnectionStrings["NeonPostgreSQL"].ConnectionString;
    
    // Atau hardcode (untuk development)
    // _connectionString = "Host=xxx;Database=xxx;...";
}
*/